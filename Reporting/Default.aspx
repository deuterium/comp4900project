        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="cmvFindEmpInDb" runat="server" ValidationGroup="vpgGetEmpFromDb"
                        ErrorMessage="Employee not found." OnServerValidate="cmvFindEmpInDb_ServerValidate"></asp:CustomValidator>
