...
<asp:Panel ID="pnlB" CssClass="panel" runat="server">
    <div id="divNatureOfInjury1">
        <asp:CheckBoxList ID="cblNatureOfInjury1" runat="server">
    ...
    <div id="divNatureOfInjury2">
        <asp:CheckBoxList ID="cblNatureOfInjury2" runat="server">
    ...
    <div id="divNatureOfInjury3">       
        <asp:CheckBoxList ID="cblNatureOfInjury3" runat="server">
            <asp:ListItem Text="Eye Irritation" ></asp:ListItem>
            <asp:ListItem Text="Allergic Response" ></asp:ListItem>
            <asp:ListItem Text="Psychogical Trauma / Aggressive Incident" ></asp:ListItem>
            <asp:ListItem Text="Respiratory Irritation" ></asp:ListItem>
        </asp:CheckBoxList>
     </div>
</asp:Panel>
...
<asp:Panel ID="pnlC" CssClass="panel" runat="server">
    ...
    <div id="divActivityLeftPanel">
        ...
        <div id="divPatientHandlingDetails">
            ...
            <p>
                ...
                <br />
                <asp:TextBox ID="tbxPatientHandlingEmpInvolved" runat="server"></asp:TextBox>
            </p>
        </div>
...
<asp:Panel ID="pnlD" CssClass="panel" runat="server">
    <div id="divCauseLeftPanel">
        ...
        <div id="divAggressionIncidentDetails">
...
<asp:Panel ID="pnlE" CssClass="panel" runat="server">
    <div id="divContributingFactorsLeftPanel">
    ...
    <div id="divContributingFactorsMiddlePanel">
        <h5>Work Practice</h5>
    ...
    <div id="divContributingFactorsRightPanel">
