<%@ Page Title="BCCA - Summary" Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Summary_Default" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="body">
    ...
    <div id="divCollapsiblePanelExtenders" visible="false">
        <asp:CollapsiblePanelExtender ID="cpeStats" runat="server" Collapsed="true"
            CollapseControlID="hr3Stats" ExpandControlID="hr3Stats"
            TargetControlID="pnlStats" CollapsedText="(Show Details)" ExpandedText="(Hide Details)"
            ImageControlID="imgExpandCollapseStats" TextLabelID="lblExpandCollapseStats"
            CollapsedImage="../images/expand.jpg" ExpandedImage="../images/collapse.jpg">
        </asp:CollapsiblePanelExtender>
        <asp:CollapsiblePanelExtender ID="cpeDept" runat="server" Collapsed="false"
            CollapseControlID="hr3Depts" ExpandControlID="hr3Depts" TargetControlID="pnlDepts"
            CollapsedText="(Show Details)" ExpandedText="(Hide Details)" ImageControlID="imgExpandCollapseDept"
            TextLabelID="lblExpandCollapseDept" CollapsedImage="../images/expand.jpg"
            ExpandedImage="../images/collapse.jpg">
        </asp:CollapsiblePanelExtender>
        <asp:CollapsiblePanelExtender ID="cpeEmployees" runat="server" Collapsed="false"
        ...
        <asp:CollapsiblePanelExtender ID="cpeTraining" runat="server" Collapsed="false"
        ...
        <asp:CollapsiblePanelExtender ID="cpeIncidents" runat="server" Collapsed="false"
        ...
        <asp:CollapsiblePanelExtender ID="cpeLabInspections" runat="server" Collapsed="false"
        ...
        <asp:CollapsiblePanelExtender ID="cpeOfficeInspections" runat="server" Collapsed="false"
    ...
    The summary page has been updated. If you would like to use the previous summary page, <a href="PrevSummary.aspx">click here</a>.
         
    <h3 id="hr3Stats">
    <asp:Image ID="imgExpandCollapseStats" runat="server" />
    Statistics
    <asp:Label ID="lblExpandCollapseStats" runat="server" Text=""></asp:Label></h3>
    <asp:Panel ID="pnlStats" runat="server" CssClass="panel" >
        <div id="divStats">
        <asp:GridView ID="gdvStats" runat="server" HeaderStyle-HorizontalAlign="Left" RowStyle-Height="30" AutoGenerateColumns="False" HorizontalAlign="Center" >
            <Columns>
                <asp:BoundField HeaderText="Statistic Name" ItemStyle-Width="300" DataField="statName" ReadOnly="True" />
                <asp:BoundField HeaderText="Statistic Value" DataField="statValue" ReadOnly="True" />
            </Columns>
            <EmptyDataTemplate>No statistics found.</EmptyDataTemplate>
        </asp:GridView>
        </div>
        <br />
        <asp:Button ID="btnPrintStats" runat="server" Text="Print" />
    </asp:Panel>
    
    <h3 id="hr3Depts">
    <asp:Image ID="imgExpandCollapseDept" runat="server" />
    Departments
    <asp:Label ID="lblExpandCollapseDept" runat="server" Text=""></asp:Label></h3>
    <asp:Panel ID="pnlDepts" runat="server" CssClass="panel" >
        ...
        <asp:GridView ID="gdvDepts" runat="server" AutoGenerateColumns="False" HorizontalAlign="Center"
                OnSelectedIndexChanged="gdvDepts_SelectedIndexChanged" OnRowDataBound="gdvDepts_RowDataBound"
                OnSorting="gdvDepts_Sorting" AllowSorting="true" ShowFooter="true"
            ...
            <Columns>
                <asp:BoundField HeaderText="#" ItemStyle-Width="30" DataField="deptNo" SortExpression="deptNo" ReadOnly="True" />
                <asp:BoundField HeaderText="Department" ItemStyle-Width="200" DataField="deptName" SortExpression="deptName" ReadOnly="True" />
                <asp:BoundField HeaderText="Employees" DataField="employees" SortExpression="employees" ReadOnly="True" />
                <asp:BoundField HeaderText="Incidents" DataField="incidents" SortExpression="incidents" ReadOnly="True" />
                <asp:BoundField HeaderText="Lab Inspections" DataField="labInspections" SortExpression="labInspections" ReadOnly="True" />
                <asp:BoundField HeaderText="Office Inspections" DataField="officeInspections" SortExpression="officeInspections" ReadOnly="True" />
                <asp:CommandField HeaderText="Click to View" HeaderStyle-Width="90" ItemStyle-HorizontalAlign="Center"
                    ShowSelectButton="True" SelectText="Select" ButtonType="Button" />      
            </Columns>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="btnDeptSearch" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="btnDeptSearchReset" EventName="Click" />
        </Triggers>
        </asp:UpdatePanel>
    </asp:Panel>
    ...
    <asp:Panel ID="pnlIncidents" runat="server" CssClass="panel" >
        ...
        <table>
            ...
            <tr>
                <td>Use advanced search:</td>
                <td>
                    <asp:RadioButtonList ID="rblAdvancedSearch" runat="server" AutoPostBack="true" 
                        RepeatDirection="Horizontal" OnSelectedIndexChanged="rblAdvancedSearch_SelectedIndexChanged">
        ...
        <asp:Panel ID="pnlAdvancedIncidentSearchContainer" CssClass="" Visible="false" runat="server">

        <h3 id="hr3AdvancedIncidentSearch">
            <asp:Image ID="imgExpandCollapseAdvancedIncident" runat="server" />
            Advanced Search
            <asp:Label ID="lblExpandCollapseAdvancedIncident" runat="server" Text=""></asp:Label></h3>
        <asp:Panel ID="pnlAdvancedIncidentSearch" CssClass="wideParentPanel" runat="server">
                                
        <asp:CollapsiblePanelExtender ID="cpeAdvancedIncidentSearch" runat="server" Collapsed="false"
            CollapseControlID="hr3AdvancedIncidentSearch" ExpandControlID="hr3AdvancedIncidentSearch" TargetControlID="pnlAdvancedIncidentSearch"
            CollapsedText="(Show Details)" ExpandedText="(Hide Details)" ImageControlID="imgExpandCollapseAdvancedIncident"
            TextLabelID="lblExpandCollapseAdvancedIncident" CollapsedImage="../images/expand.jpg"
            ExpandedImage="../images/collapse.jpg">
        </asp:CollapsiblePanelExtender>
        ...
        <asp:Panel ID="pnlFiltersSelectedContainer" runat="server">
            <asp:Label ID="lblAdvancedFilters" Visible="false" runat="server" Text="The advanced search options you selected were:" Font-Bold="true" />
            <asp:Label ID="lblNoAdvancedFilters" runat="server" Text="No advanced search options selected." Font-Bold="true" />
            <asp:Label ID="lblAdvancedFiltersReminder" runat="server" Text="To do an advanced search, select 'Yes' to the 'Use advanced search' option above."></asp:Label>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="rblAdvancedSearch" EventName="SelectedIndexChanged" />
        </Triggers>
        </asp:UpdatePanel>
    </asp:Panel>
